...
A partir do cenário quatro, também podemos corroborar nossa escolha em separar os pacientes em 5 classes, sendo eles os que morreram na primeira semana, segunda, terceira, quarta e os que sobreviveram. Entre os 305 pacientes que vieram a óbito, 58 morreram em menos de 7 dias, 161 na segunda semana, 83 na terceira e apenas 3 na quarta, indicando assim, que a criação de categorias para maiores quantidade de tempo seriam infrutíferas. 
